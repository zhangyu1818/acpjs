...
- 52f041c: Expose the agent's `agentInfo` (ACP `Implementation`: name/title/version) on `AgentSnapshot`, and bump `@agentclientprotocol/sdk` to `^1.0.0`.
...
- 062d49f: Record client-originated prompts in the session history.
